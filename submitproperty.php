...
if (isset($_POST['add'])) {
    ...
    $properties = mysqli_fetch_all($prediction_query, MYSQLI_ASSOC);
    $features = [];
    $prices = [];
    ...
    if ($total_similar_properties > 0) {
        $predicted_price /= $total_similar_properties;
        $msg .= "<p class='alert alert-info'>Predicted Price for similar properties: $predicted_price</p>";
    } else {
